...
// Variavel que armazena as coordenadas do clique do mouse
double P[2] = {0.0, 0.0};

bool scrInteractor::mouseLeftIsClicked()
{
    return this->mouse_left;
}

double* scrInteractor::getP() { return P; }
...
{
    float quat[4];quat[0]=1;quat[1]=0;quat[2]=0;quat[3]=cos(1.0*3.1459/2.0);
    this->trackball.Add_Quats(quat);
    auxMatrix::Mult_Matrix(&this->matrix, this->trackball.getMatrix());
